...
| [`moneta_wealth`](https://github.com/lohwswilson/moneta_wealth) | Odoo 18 module. Sync store, licensing, and the same features for subscribers who use the web backend. | LGPL-3.0 |
